...
private:
	BlockHeader* listHead;		// you need a head of the list
public:
	int listLength;
	LinkedList();
	// adds a block header to the list
	void insert (BlockHeader* b);
	// removes a block header from the list
	void remove (BlockHeader* b);
	//get the length of the linked list
	int getListLength();
	//get the head node of the linked list (BlockHeader*)
	BlockHeader* getHead();
};
...
private:
	...
	int nextFreeBlock(uint sizeNeeded);
