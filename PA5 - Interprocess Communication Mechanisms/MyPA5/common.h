...
//message requesting a new channel
// class newchannelmsg{
// public:
//   MESSAGE_TYPE mtype;
//   newchannelmsg(){
...
RequestChannel* create_channel (string communicationMethod, string name, RequestChannel::Side _side, int _m);
